...
const RestaurantsNearYou = () => {
  const [restaurants, setRestaurants] = useState([
    ...
    { id: 13, name: 'Panera Bread', rating: 4.5, time: '20-30 min', tags: 'Sandwiches', isWishlisted: false, image: 'https://img.cdn4dd.com/cdn-cgi/image/fit=cover,width=1000,height=300,format=auto,quality=80/https://doordash-static.s3.amazonaws.com/media/store/header/2ff6e691-1eca-46c4-8b22-ffb753ad1331.png' },
    { id: 14, name: 'Chick-fil-A', rating: 4.6, time: '15-25 min', tags: 'Fried Chicken', isWishlisted: false, image: 'https://www.shutterstock.com/image-photo/chickfila-food-on-table-restaurant-260nw-2292494475.jpg' },
    { id: 15, name: 'Tim Hortons', rating: 4.1, time: '10-20 min', tags: 'Coffee', isWishlisted: false, image: 'https://external-preview.redd.it/super-popular-canadian-chain-tim-hortons-will-open-in-the-v0-Pmv9SMr1Cgn7wHQ7jXpLbJuFGfxN7G6gTd5xbABGEWw.jpg?width=640&crop=smart&auto=webp&s=7dcfbc6351725c2c0874a4f0a71f5fee40697f00' },
    { id: 16, name: 'Qdoba', rating: 4.2, time: '20-30 min', tags: 'Mexican', isWishlisted: false, image: 'https://www.eatthis.com/wp-content/uploads/sites/4/2024/09/qdoba-chicken-queso-burrito.jpg?quality=82&strip=all&w=640' },
    { id: 17, name: 'In-N-Out Burger', rating: 4.7, time: '15-25 min', tags: 'Fast food', isWishlisted: false, image: 'https://media-cdn.tripadvisor.com/media/photo-o/12/6e/80/38/burger-and-fries.jpg' },
    { id: 18, name: 'Little Caesars', rating: 3.9, time: '25-35 min', tags: 'Pizza', isWishlisted: false, image: 'https://static.vecteezy.com/system/resources/thumbnails/046/862/588/small/a-slice-of-cheesy-pizza-with-stretchy-mozzarella-free-photo.jpeg' },
    { id: 19, name: 'Jersey Mike\'s', rating: 4.4, time: '20-30 min', tags: 'Sandwiches', isWishlisted: false, image: 'https://www.mashed.com/img/gallery/the-untold-truth-of-jersey-mikes/healthy-aspirations-1553878393.jpg' },
    { id: 20, name: 'Popeyes', rating: 4.0, time: '25-35 min', tags: 'Fried Chicken', isWishlisted: false, image: 'https://t4.ftcdn.net/jpg/09/77/24/99/360_F_977249927_xjtdyW0zJBZV00V6uO2j6QKYAFcDQsQx.jpg' },
